					...
					switch(obj.node){
						...
						default:
							...
							var style = window.getComputedStyle(d),
								ni;
							for(ni = 0; ni < style.length; ni++){
								obj.style[style.item(ni)] = style.getPropertyValue(style.item(ni));
							}
							break;
					}
